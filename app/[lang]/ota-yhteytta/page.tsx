    ...
    <>
      ...
      <section className="py-16" style={{ backgroundColor: 'var(--brand)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white uppercase tracking-tight mb-3 break-words">{t('contact.title')}</h1>
            ...
            <Reveal delay={0.12} className="space-y-5">
              <div className="bg-white rounded-2xl border border-border p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { icon: Mail, label: t('contact.info.email'), content: ORG.email, href: `mailto:${ORG.email}` },
                    { icon: Phone, label: t('contact.info.phone'), content: ORG.phoneDisplay, href: `tel:${ORG.phone}` },
              ...
              <div className="bg-white rounded-2xl border border-border overflow-hidden">
                ...
                {showMap ? (
                  ...
                  <div
                    className="flex flex-col items-center justify-center text-center px-6 py-10 gap-4"
                    style={{ height: 220, backgroundColor: 'var(--bg)' }}
                  >
                    <MapPin size={28} style={{ color: 'var(--brand)' }} />
